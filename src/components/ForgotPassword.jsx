  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-slate-100 dark:bg-slate-900">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg dark:bg-slate-800">
        ...
        <p className="mt-2 text-center text-sm text-slate-500 dark:text-slate-400">Enter your email and we’ll send a reset link.</p>
        ...
        {message && <p className="mt-5 rounded-lg bg-green-50 px-3 py-2 text-center text-sm text-green-700 dark:bg-green-900/20 dark:text-green-400">{message}</p>}
